...
void deleteByKey(int arr[], int *n , int key){
        ...
        for(int j=found;j<*n-1;j++) arr[j] = arr[j+1];
        (*n)--;
        printf("\n");
}
void insertByOrder(int arr[], int *n, int val){
        int i;
        for(i=*n-1;(i>=0 && arr[i] > val); --i) arr[i+1] = arr[i];
        arr[i+1] = val;
        (*n)++;
        printf("\n");
}
...
int main(){
        ...
        if(type == 2){
                ...
                for(int i=0;i<n;++i) scanf("%d", &dynamic[i]);
        }
        else{
                printf("Enter no. of elements: ");
                scanf("%d", &n);
                printf("Enter %d elements", n);
                for(int i=0;i<n;++i) scanf("%d", &staticc[i]);
        }do{
                        ...
                        switch(choice){
                                ...
                                case 6:
                                        ...
                                        if(pos!=-1) printf("Key found at position %d", pos);
                                ...
                                case 7:
                                        ...
                                        if(val!=-1) printf("Value at position %d is %d", pos, val);
                                        else printf("INVALID POSITOIN\n");
                                        break;
